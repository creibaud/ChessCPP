...
Bishop::Bishop(PieceColor color, Coordinates coordinates) : Piece(PieceType::BISHOP, color, coordinates) {}

void Bishop::setPossibleAttacks(std::vector<Piece*> *playerPieces, std::vector<Piece*> *enemyPieces) {
...
void Bishop::setPossibleMoves(std::vector<Piece*> *playerPieces, std::vector<Piece*> *enemyPieces) {
