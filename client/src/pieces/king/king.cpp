...
King::King(PieceColor color, Coordinates coordinates) : Piece(PieceType::KING, color, coordinates) {}

void King::setPossibleAttacks(std::vector<Piece*> *playerPieces, std::vector<Piece*> *enemyPieces) {
...
void King::setPossibleMoves(std::vector<Piece*> *playerPieces, std::vector<Piece*> *enemyPieces) {
